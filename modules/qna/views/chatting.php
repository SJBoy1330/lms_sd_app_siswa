                            ...
                            <div class="col">
                                <div class="form-group mb-2">
                                    <div class="wrapper-password d-flex">
                                        ...
                                        <input type="text" class="form-control form-control-pribadi input-field chatting" name="pesan" id="pesan" placeholder="Tulis Pesan" autocomplete="off">
                            ...
                            <div class="modal-body">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url(<?= base_url(); ?>assets/images/no-photo-big.png);"></div>
                                    </div>
                                </div>
                            </div>
